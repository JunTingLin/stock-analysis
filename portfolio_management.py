...
def update_current_portfolio_info_with_datetime(position_acc, datetime, pkl_path):
...
def get_info_with_datetime(datetime, pkl_path):
    if os.path.exists(pkl_path):
...
def update_financial_summary_with_datetime(acc, datetime, financial_summary_pkl_path):
    bank_balance = acc.get_cash()
    total_settlement_amount = acc.get_settlement()
    adjusted_bank_balance = acc.get_cash() +  acc.get_settlement()
...
if __name__ == '__main__':
    ...
    # current_portfolio =  update_current_portfolio_info_with_datetime(acc.get_position(), d, 'current_portfolio.pkl')
    # print(current_portfolio)
    # financial_summary = update_financial_summary_with_datetime(acc, d, 'financial_summary.pkl')
    # print(financial_summary)
    next_portfolio_info = update_next_portfolio_info_with_datetime(None, d, 'next_portfolio.pkl')
