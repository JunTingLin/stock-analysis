...
class AlanTwStrategy2:
    ...
    def run_strategy(self):
        ...
        buy_signal = ( self.build_chip_buy_condition(top_n=20) & self.build_technical_buy_condition() &  self.build_fundamental_buy_condition(op_growth_threshold=1.001) ) | \
        ( self.build_chip_buy_condition(top_n=60) & self.build_technical_buy_condition() &  self.build_fundamental_buy_condition(op_growth_threshold=1.10) ) | \
        ( self.build_chip_buy_condition(top_n=80) & self.build_technical_buy_condition() &  self.build_fundamental_buy_condition(op_growth_threshold=1.20) ) | \
        ( self.build_chip_buy_condition(top_n=100) & self.build_technical_buy_condition() &  self.build_fundamental_buy_condition(op_growth_threshold=1.30) )
