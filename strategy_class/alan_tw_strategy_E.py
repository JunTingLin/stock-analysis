"""
Alan TW Strategy E
策略 E: top_n=40, 營業利益率成長 15%, BIAS: 3~13, 5~16, 8~21, 8~20, 5~29, 8~32, 創480天新高

此策略結合三大面向：
- 籌碼面：三大法人與主力買賣超
- 技術面：均線、乖離率、DMI、KD、MACD等指標，並追加創480天新高條件
- 基本面：營業利益率成長
"""
...
class AlanTWStrategyE:
    """
    Alan TW Strategy E - 策略E
    ...
    def _build_technical_buy_condition(self):
        ...
        # 創新高 - 使用指定天數
        high_n = self.adj_close.rolling(window=self.new_high_days).max()
